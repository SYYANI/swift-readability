...
struct ReadabilityTests {
    ...
    @Test("parse removes ar5iv page chrome and LaTeXML front matter before first section")
    func testParseRemovesAr5ivPageChromeAndFrontMatter() throws {
        let introParagraph = Array(repeating: "This introduction paragraph contains enough text, commas, and detail to behave like real article content.", count: 8)
            .joined(separator: " ")
        let html = """
        <html>
        <head>
          <title>[2412.19437] DeepSeek-V3 Technical Report</title>
        ...
        <body>
          <div class="ltx_page_main">
            <div class="ltx_page_content">
              <article class="ltx_document ltx_authors_1line">
                <div class="ltx_para" id="p1">
                  <span class="ltx_ERROR undefined">\\reportnumber</span>
                  <p class="ltx_p">001</p>
                </div>
                ...
                <figure class="ltx_figure" id="S0.F1" lang="en">
                  <img alt="Refer to caption" class="ltx_graphics ltx_img_landscape" height="255" id="S0.F1.g1" src="/html/2412.19437/assets/x1.png" width="436"/>
                  <figcaption class="ltx_caption"><span class="ltx_tag ltx_tag_figure">Figure 1: </span>Benchmark summary figure.</figcaption>
                </figure>
                <div class="ltx_pagination ltx_role_newpage"></div>
                <nav class="ltx_TOC ltx_list_toc ltx_toc_toc" lang="en">
            ...
            <div class="ar5iv-footer">
              <a href="/html/2412.19436" class="ar5iv-nav-button ar5iv-nav-button-prev">◄</a>
              <a class="ar5iv-home-button" href="/"><img height="40" alt="ar5iv homepage" src="/assets/ar5iv.png"></a>
              <a href="/feeling_lucky" class="ar5iv-text-button">Feeling<br>lucky?</a>
              <a href="/log/2412.19437" class="ar5iv-text-button ar5iv-severity-error">Conversion<br>report</a>
              <a class="ar5iv-text-button" target="_blank" href="https://github.com/dginev/ar5iv/issues/new?template=improve-article--arxiv-id-.md&title=Improve+article+2412.19437">Report<br>an issue</a>
              <a href="https://arxiv.org/abs/2412.19437" class="ar5iv-text-button arxiv-ui-theme">View&nbsp;original<br>on&nbsp;arXiv</a>
              <a href="/html/2412.19438" class="ar5iv-nav-button ar5iv-nav-button-next">►</a>
            </div>
            <footer class="ltx_page_footer">
              <a class="ar5iv-toggle-color-scheme" href="javascript:toggleColorScheme()" title="Toggle ar5iv color scheme"><span class="color-scheme-icon"></span></a>
              <a class="ar5iv-footer-button" href="https://arxiv.org/help/license" target="_blank">Copyright</a>
              <a class="ar5iv-footer-button" href="https://arxiv.org/help/policies/privacy_policy" target="_blank">Privacy Policy</a>
              <div class="ltx_page_logo">Generated by <a target="_blank" href="http://dlmf.nist.gov/LaTeXML/" class="ltx_LaTeXML_logo">LaTeXML</a></div>
            </footer>
          </div>
        </body>
        </html>
        ...
        let readability = try Readability(
            html: html,
            baseURL: URL(string: "https://ar5iv.labs.arxiv.org/html/2412.19437")
        )
        let result = try readability.parse()

        #expect(result.title == "DeepSeek-V3 Technical Report")
        #expect(result.content.contains("Abstract"))
        #expect(result.content.contains("Introduction"))
        #expect(!result.content.contains("\\reportnumber"))
        #expect(!result.content.contains("Contents"))
        #expect(!result.content.contains("S0.F1.g1"))
        #expect(!result.content.contains("Benchmark summary figure"))
        #expect(!result.content.contains("Feeling lucky?"))
        #expect(!result.content.contains("Conversion report"))
        #expect(!result.content.contains("Report an issue"))
        #expect(!result.content.contains("View original"))
        #expect(!result.content.contains("Toggle ar5iv color scheme"))
        #expect(!result.content.contains("Privacy Policy"))
        #expect(!result.content.contains("LaTeXML"))
    }
